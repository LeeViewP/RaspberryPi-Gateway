exports.metrics = {
    ...
    MINC: { name: 'MINC',regexp:/\bMINC\:([-\d\.]+)\b/i, value: '', unit: '°', pin: 1 },
    AVGC: { name: 'AVGC',regexp:/\bAVGC\:([-\d\.]+)\b/i, value: '', unit: '°', pin: 1 },
    AVGH: { name: 'AVGH',regexp:/\bAVGH\:([-\d\.]+)\b/i, value: '', unit: '%', pin: 1 },
    AVGP: { name: 'AVGP',regexp:/\bAVGP\:([-\d\.]+)\b/i, value: '', unit: 'mmHg', pin: 1 },
};