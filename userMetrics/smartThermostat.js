...
exports.motes = {
    SmartThermostat: {
        label: 'Smart Thermostat (AI Based)',
...
exports.events = {
    ...
    smartthermostatfunction: {
        ...
        scheduledExecute: function (node) {
            ...
            // Find comfort type
            var currentComfortType = metricsDef.comfortTypes[currentSchedule.comfortType]
            console.log('Smart Thermostat Functionality: current Comfort Type ' + JSON.stringify(currentComfortType));
            var targetTemperature = 0;
            var outsideTemperature = 30; //settings.meteoforecast.nodeId.value
            var currentInternalTemperature = settings.smartthermostat.temperaturefortest.value
